...
namespace WhiteFeeder
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            A = new Menu("White Feeder", "unrealfeeder", true);
            A.AddItem(new MenuItem("root.shouldfeed", "Feeding Enabled").SetValue(false));
            A.AddItem(new MenuItem("root.feedmode", "Feeding Mode:").SetValue(new StringList(new[] { "Closest Enemy", "Bottom Lane", "Middle Lane", "Top Lane", "Wait at Dragon", "Wait at Baron", "Most Fed", "Highest Carrying Potential" }
            )));
            A.AddItem(new MenuItem("root.defaultto", "Default To:").SetValue(new StringList(new[] { "Bottom Lane", "Top Lane", "Middle Lane" }
            )));
            ...
            A.AddItem(new MenuItem("hehehe5", "Made by Hawk"));
            ...
            {
                Notifications.AddNotification("White Feeder: Team Chaos", 300);
            }
            else Notifications.AddNotification("White Feeder: Team Order", 300);
